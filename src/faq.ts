...
export const FAQ_TEXT = [
  ...
  'Galileo is the verifiable AI wallet on 0G — no value moves without a proof. Every value-moving action (send, swap, DCA, alert, key-reveal) emits a *Verified Intent Receipt* on 0G Storage, ending with a public verification link at `/verify/:root`.',
  ...
  'Every AI reply is TEE-attested on 0G Compute. `/proof` shows your last 10 verified chat IDs; `/receipt` lists your recent Verified Intent Receipts with root hashes.',
  '',
  '─ 6. Stay safe ─',
